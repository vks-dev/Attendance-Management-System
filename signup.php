  ...
  try{
      ...
      if(isset($_POST['signup'])){
        ...
        if ($_POST['type'] == 'student') {
          $result = mysqli_query($conn,"insert into students(username,password,email,fname,phone,type) values('$_POST[uname]','$_POST[pass]','$_POST[email]','$_POST[fname]','$_POST[phone]','$_POST[type]')");
