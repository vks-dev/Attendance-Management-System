  ...
  try{
    ...
    if(isset($_POST['std'])){
      ...
      //students data insertion to database table "students"
        $result = mysqli_query($conn, "insert into students(st_id,st_name,st_uname,st_password,st_dept,st_batch,st_sem,st_email) values('$_POST[st_id]','$_POST[st_name]','$_POST[uname]','$_POST[pass]','$_POST[st_dept]','$_POST[st_batch]','$_POST[st_sem]','$_POST[st_email]')");
        ...
        if(isset($_POST['tcr'])){
          ...
          $res = mysqli_query($conn,"insert into teachers(tc_id,tc_name,tc_uname,tc_password,tc_dept,tc_email,tc_phone,tc_course) values('$_POST[tc_id]','$_POST[tc_name]','$_POST[tc_uname]','$_POST[tc_pass]','$_POST[tc_dept]','$_POST[tc_email]','$_POST[phone]','$_POST[tc_course]')");
...
<!-- Error or Success Message printint ended -->
  ...
  <?php
    ...
    $adminNameQuery = mysqli_query($conn, "select fname from admininfo where username = '$admin';");
    $row = mysqli_fetch_array($adminNameQuery, MYSQLI_NUM);
    echo $row[0];
...
<br><br><br>
  <div class="rowtwo" id="teacher">
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Username</label>
          <div class="col-sm-7">
            <input type="text" name="tc_uname"  class="form-control" id="input1" placeholder="choose username" />
          </div>
      </div>
      ...
      <div class="form-group">
          <label for="input1" class="col-sm-3 control-label">Password</label>
          <div class="col-sm-7">
            <input type="password" name="tc_pass"  class="form-control" id="input1" placeholder="choose a strong password" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="phone"  class="form-control" id="input1" placeholder="teacher phone number" />
          </div>
      </div>
