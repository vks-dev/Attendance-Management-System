...
if(isset($_POST['login']))
{
	...
	try{
		...
		if ($_POST["type"] == "student") {
			$result = mysqli_query($conn, "select * from students where st_uname='$_POST[username]' and st_password='$_POST[password]';");

			$row=mysqli_num_rows($result);
		}
		
		else if ($_POST["type"] == "teacher") {
			$result = mysqli_query($conn, "select * from teachers where tc_uname='$_POST[username]' and tc_password='$_POST[password]';");
...
<html>
	...
	<body>
		...
		<footer>
			<div>&copy; 2023 | Rise Krishna Sai Prakasam CSE Students.</div>
